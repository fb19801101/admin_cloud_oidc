package com.provider_oidc_dynamicplan.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_dynamicplan.domain.DateUtils;
import com.provider_oidc_dynamicplan.domain.RPHolder;
import com.provider_oidc_dynamicplan.domain.shared.Application;
import com.provider_oidc_dynamicplan.entity.AuthEntityRepository;
import com.provider_oidc_dynamicplan.entity.OrgLogEntityRepository;
import com.provider_oidc_dynamicplan.entity.PortalData;
import com.provider_oidc_dynamicplan.entity.PostChangeLogEntityRepository;
import com.provider_oidc_dynamicplan.service.OIDCClientService;
import com.provider_oidc_dynamicplan.service.dto.UserInfoDto;
...
public class DevDynamicPlanController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12188/dynamicplan/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12188/dynamicplan/message");
