package com.provider_oidc_dynamicplan.infrastructure;

import com.provider_oidc_dynamicplan.domain.RPHolder;
import com.provider_oidc_dynamicplan.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_dynamicplan/oidc-dynamicplan-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-dynamicplan/oidc-dynamicplan-rpholder.json";
