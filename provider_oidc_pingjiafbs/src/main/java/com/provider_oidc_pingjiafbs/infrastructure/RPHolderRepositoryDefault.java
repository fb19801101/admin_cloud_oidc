package com.provider_oidc_pingjiafbs.infrastructure;

import com.provider_oidc_pingjiafbs.domain.RPHolder;
import com.provider_oidc_pingjiafbs.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_pingjiafbs/oidc-pingjiafbs-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-pingjiafbs/oidc-pingjiafbs-rpholder.json";
