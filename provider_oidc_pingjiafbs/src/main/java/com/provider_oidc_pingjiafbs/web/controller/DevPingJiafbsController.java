...
import com.provider_oidc_pingjiafbs.entity.AuthEntityRepository;
import com.provider_oidc_pingjiafbs.entity.OrgLogEntityRepository;
import com.provider_oidc_pingjiafbs.entity.PortalData;
import com.provider_oidc_pingjiafbs.entity.PostChangeLogEntityRepository;
import com.provider_oidc_pingjiafbs.service.OIDCClientService;
import com.provider_oidc_pingjiafbs.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/pingjiafbs")
public class DevPingJiafbsController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12171/pingjiafbs/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12171/pingjiafbs/message");
