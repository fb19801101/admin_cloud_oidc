package com.provider_oidc_wuzibm.infrastructure;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_wuzibm/oidc-wuzibm-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-wuzibm/oidc-wuzibm-rpholder.json";
