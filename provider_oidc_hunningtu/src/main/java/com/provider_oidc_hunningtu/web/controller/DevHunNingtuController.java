package com.provider_oidc_hunningtu.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_hunningtu.domain.DateUtils;
import com.provider_oidc_hunningtu.domain.RPHolder;
import com.provider_oidc_hunningtu.domain.shared.Application;
import com.provider_oidc_hunningtu.entity.AuthEntityRepository;
import com.provider_oidc_hunningtu.entity.OrgLogEntityRepository;
import com.provider_oidc_hunningtu.entity.PortalData;
import com.provider_oidc_hunningtu.entity.PostChangeLogEntityRepository;
import com.provider_oidc_hunningtu.service.OIDCClientService;
import com.provider_oidc_hunningtu.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/hunningtu")
public class DevHunNingtuController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12183/hunningtu/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12183/hunningtu/message");
