package com.provider_oidc_hunningtu.infrastructure;

import com.provider_oidc_hunningtu.domain.RPHolder;
import com.provider_oidc_hunningtu.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_hunningtu/oidc-hunningtu-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-hunningtu/oidc-hunningtu-rpholder.json";
