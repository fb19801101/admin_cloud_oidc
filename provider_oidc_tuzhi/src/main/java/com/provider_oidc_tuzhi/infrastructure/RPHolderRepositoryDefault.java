package com.provider_oidc_tuzhi.infrastructure;

import com.provider_oidc_tuzhi.domain.RPHolder;
import com.provider_oidc_tuzhi.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_tuzhi/oidc-tuzhi-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-tuzhi/oidc-tuzhi-rpholder.json";
