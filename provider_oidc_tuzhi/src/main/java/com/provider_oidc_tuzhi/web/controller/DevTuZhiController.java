package com.provider_oidc_tuzhi.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_tuzhi.domain.DateUtils;
import com.provider_oidc_tuzhi.domain.RPHolder;
import com.provider_oidc_tuzhi.domain.shared.Application;
import com.provider_oidc_tuzhi.entity.AuthEntityRepository;
import com.provider_oidc_tuzhi.entity.OrgLogEntityRepository;
import com.provider_oidc_tuzhi.entity.PortalData;
import com.provider_oidc_tuzhi.entity.PostChangeLogEntityRepository;
import com.provider_oidc_tuzhi.service.OIDCClientService;
import com.provider_oidc_tuzhi.service.dto.UserInfoDto;
...
public class DevTuZhiController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12184/tuzhi/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12184/tuzhi/message");
