package com.provider_oidc_hrext.infrastructure;

import com.provider_oidc_hrext.domain.RPHolder;
import com.provider_oidc_hrext.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_hrext/oidc-hrext-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-hrext/oidc-hrext-rpholder.json";
