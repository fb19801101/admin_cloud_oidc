...
import com.provider_oidc_hrext.entity.AuthEntityRepository;
import com.provider_oidc_hrext.entity.OrgLogEntityRepository;
import com.provider_oidc_hrext.entity.PortalData;
import com.provider_oidc_hrext.entity.PostChangeLogEntityRepository;
import com.provider_oidc_hrext.service.OIDCClientService;
import com.provider_oidc_hrext.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/hrext")
public class DevHrExtController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12173/hrext/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12173/hrext/message");
