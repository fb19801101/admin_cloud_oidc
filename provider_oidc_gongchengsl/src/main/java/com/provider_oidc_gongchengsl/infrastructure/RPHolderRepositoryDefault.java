package com.provider_oidc_gongchengsl.infrastructure;

import com.provider_oidc_gongchengsl.domain.RPHolder;
import com.provider_oidc_gongchengsl.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gongchengsl/oidc-gongchengsl-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gongchengsl/oidc-gongchengsl-rpholder.json";
