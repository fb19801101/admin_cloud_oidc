package com.provider_oidc_gongchengsl.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gongchengsl.domain.DateUtils;
import com.provider_oidc_gongchengsl.domain.RPHolder;
import com.provider_oidc_gongchengsl.domain.shared.Application;
import com.provider_oidc_gongchengsl.entity.AuthEntityRepository;
import com.provider_oidc_gongchengsl.entity.OrgLogEntityRepository;
import com.provider_oidc_gongchengsl.entity.PortalData;
import com.provider_oidc_gongchengsl.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongchengsl.service.OIDCClientService;
import com.provider_oidc_gongchengsl.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/gongchengsl")
public class DevGongChengslController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12185/gongchengsl/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12185/gongchengsl/message");
