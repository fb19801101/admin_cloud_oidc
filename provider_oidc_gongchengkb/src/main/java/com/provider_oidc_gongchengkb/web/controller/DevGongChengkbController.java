package com.provider_oidc_gongchengkb.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gongchengkb.domain.DateUtils;
import com.provider_oidc_gongchengkb.domain.RPHolder;
import com.provider_oidc_gongchengkb.domain.shared.Application;
import com.provider_oidc_gongchengkb.entity.AuthEntityRepository;
import com.provider_oidc_gongchengkb.entity.OrgLogEntityRepository;
import com.provider_oidc_gongchengkb.entity.PortalData;
import com.provider_oidc_gongchengkb.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongchengkb.service.OIDCClientService;
import com.provider_oidc_gongchengkb.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/gongchengkb")
public class DevGongChengkbController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12177/gongchengkb/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12177/gongchengkb/message");
