package com.provider_oidc_gongchengkb.infrastructure;

import com.provider_oidc_gongchengkb.domain.RPHolder;
import com.provider_oidc_gongchengkb.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gongchengkb/oidc-gongchengkb-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gongchengkb/oidc-gongchengkb-rpholder.json";
