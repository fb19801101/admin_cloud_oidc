package com.provider_oidc_wuzigys.infrastructure;

import com.provider_oidc_wuzigys.domain.RPHolder;
import com.provider_oidc_wuzigys.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_wuzigys/oidc-wuzigys-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-wuzigys/oidc-wuzigys-rpholder.json";
