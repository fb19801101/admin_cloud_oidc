package com.provider_oidc_wuzigys.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_wuzigys.domain.DateUtils;
import com.provider_oidc_wuzigys.domain.RPHolder;
import com.provider_oidc_wuzigys.domain.shared.Application;
import com.provider_oidc_wuzigys.entity.AuthEntityRepository;
import com.provider_oidc_wuzigys.entity.OrgLogEntityRepository;
import com.provider_oidc_wuzigys.entity.PortalData;
import com.provider_oidc_wuzigys.entity.PostChangeLogEntityRepository;
import com.provider_oidc_wuzigys.service.OIDCClientService;
import com.provider_oidc_wuzigys.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/wuzigys")
public class DevWuZigysController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12193/wuzigys/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12193/wuzigys/message");
