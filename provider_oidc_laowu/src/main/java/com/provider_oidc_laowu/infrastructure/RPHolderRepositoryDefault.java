package com.provider_oidc_laowu.infrastructure;

import com.provider_oidc_laowu.domain.RPHolder;
import com.provider_oidc_laowu.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_laowu/oidc-laowu-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-laowu/oidc-laowu-rpholder.json";
