...
import com.provider_oidc_laowu.entity.AuthEntityRepository;
import com.provider_oidc_laowu.entity.OrgLogEntityRepository;
import com.provider_oidc_laowu.entity.PortalData;
import com.provider_oidc_laowu.entity.PostChangeLogEntityRepository;
...
public class DevLaoWuController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12196/laowu/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12196/laowu/message");
