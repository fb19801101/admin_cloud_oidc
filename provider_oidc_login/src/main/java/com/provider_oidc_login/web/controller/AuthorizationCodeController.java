...
import com.provider_oidc_login.domain.TokenHolder;
import com.provider_oidc_login.domain.shared.Application;
import com.provider_oidc_login.entity.AuthEntityRepository;
import com.provider_oidc_login.entity.OrgLogEntityRepository;
import com.provider_oidc_login.entity.PostChangeLogEntityRepository;
import com.provider_oidc_login.service.OIDCClientService;
import com.provider_oidc_login.service.dto.*;
...
//                return new CRCCUserInfoDto();
    ...
    public RedirectView authorizationCallback(AuthCallbackDto callbackDto, final RedirectAttributes redirectAttributes) throws Exception {
        ...
        authAccessTokenDto.setScope("openid");
        authAccessTokenDto.setRedirectUri(Application.host("authorization_callback"));
        DevRetController.accessTokenDto = clientService.retrieveAccessTokenDto_(authAccessTokenDto);
        UserInfoDto userInfoDto = clientService.loadUserInfoDto_(DevRetController.accessTokenDto.getAccessToken());
        if(userInfoDto != null) {
