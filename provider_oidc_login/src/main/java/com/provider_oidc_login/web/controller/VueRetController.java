...
import com.provider_oidc_login.domain.auth.AuthRoleDetails;
import com.provider_oidc_login.domain.auth.AuthRoleDetailsRepository;
import com.provider_oidc_login.domain.shared.Application;
import com.provider_oidc_login.entity.*;
...
public class VueRetController {
    ...
    public boolean checkAccessToken() {
        ...
        UserInfoDto userInfoDto = clientService.loadUserInfoDto_(accessToken.getAccessToken());
        if(userInfoDto != null) {
