package com.provider_oidc_login.infrastructure;

import com.provider_oidc_login.domain.RPHolder;
import com.provider_oidc_login.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_login/oidc-login-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-login/oidc-login-rpholder.json";
