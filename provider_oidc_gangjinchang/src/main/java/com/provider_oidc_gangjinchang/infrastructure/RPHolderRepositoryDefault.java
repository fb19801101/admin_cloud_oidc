package com.provider_oidc_gangjinchang.infrastructure;

import com.provider_oidc_gangjinchang.domain.RPHolder;
import com.provider_oidc_gangjinchang.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gangjinchang/oidc-gangjinchang-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gangjinchang/oidc-gangjinchang-rpholder.json";
