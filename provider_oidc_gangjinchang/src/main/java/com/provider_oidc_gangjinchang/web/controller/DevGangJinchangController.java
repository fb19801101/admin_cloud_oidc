package com.provider_oidc_gangjinchang.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gangjinchang.domain.DateUtils;
import com.provider_oidc_gangjinchang.domain.RPHolder;
import com.provider_oidc_gangjinchang.domain.shared.Application;
import com.provider_oidc_gangjinchang.entity.AuthEntityRepository;
import com.provider_oidc_gangjinchang.entity.OrgLogEntityRepository;
import com.provider_oidc_gangjinchang.entity.PortalData;
import com.provider_oidc_gangjinchang.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gangjinchang.service.OIDCClientService;
import com.provider_oidc_gangjinchang.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/gangjinchang")
public class DevGangJinchangController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12182/gangjinchang/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12182/gangjinchang/message");
