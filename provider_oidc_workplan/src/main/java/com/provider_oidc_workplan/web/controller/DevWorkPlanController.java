package com.provider_oidc_workplan.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_workplan.domain.DateUtils;
import com.provider_oidc_workplan.domain.RPHolder;
import com.provider_oidc_workplan.domain.shared.Application;
import com.provider_oidc_workplan.entity.AuthEntityRepository;
import com.provider_oidc_workplan.entity.OrgLogEntityRepository;
import com.provider_oidc_workplan.entity.PortalData;
import com.provider_oidc_workplan.entity.PostChangeLogEntityRepository;
import com.provider_oidc_workplan.service.OIDCClientService;
import com.provider_oidc_workplan.service.dto.UserInfoDto;
...
public class DevWorkPlanController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12187/workplan/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12187/workplan/message");
