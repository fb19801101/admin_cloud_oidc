package com.provider_oidc_workplan.infrastructure;

import com.provider_oidc_workplan.domain.RPHolder;
import com.provider_oidc_workplan.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_workplan/oidc-workplan-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-workplan/oidc-workplan-rpholder.json";
