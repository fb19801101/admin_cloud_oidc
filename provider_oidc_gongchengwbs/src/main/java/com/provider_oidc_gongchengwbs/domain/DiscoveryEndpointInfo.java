package com.provider_oidc_gongchengwbs.domain;
 ...
 * "user_name"
 * ],
 * "jwks_uri": "http://localhost:8070/oidc-server/public/jwks",
 ...
 * "RS256"
 * ],
 * "registration_endpoint": "http://localhost:8070/oidc-server/public/registration",
 * "scopes_supported": [
 * "openid",
 * "read",
 * "write"
 * ],
 * "issuer": "http://localhost:8080/oidc-server/",
 * "authorization_endpoint": "http://localhost:8070/oidc-server/oauth/authorize",
 * "token_endpoint": "http://localhost:8070/oidc-server/oauth/token",
 * "userinfo_endpoint": "http://localhost:8070/oidc-server/api/userinfo"
 * }
 * </pre>
 *
 * @author 信息化管理部-方波
