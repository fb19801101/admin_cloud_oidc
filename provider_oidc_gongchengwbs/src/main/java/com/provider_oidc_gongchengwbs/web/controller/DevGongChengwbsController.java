package com.provider_oidc_gongchengwbs.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gongchengwbs.domain.DateUtils;
import com.provider_oidc_gongchengwbs.domain.RPHolder;
import com.provider_oidc_gongchengwbs.domain.shared.Application;
import com.provider_oidc_gongchengwbs.entity.AuthEntityRepository;
import com.provider_oidc_gongchengwbs.entity.OrgLogEntityRepository;
import com.provider_oidc_gongchengwbs.entity.PortalData;
import com.provider_oidc_gongchengwbs.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongchengwbs.service.OIDCClientService;
import com.provider_oidc_gongchengwbs.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/gongchengwbs")
public class DevGongChengwbsController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12191/gongchengwbs/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12191/gongchengwbs/message");
