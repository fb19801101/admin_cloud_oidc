package com.provider_oidc_gongchengwbs.infrastructure;

import com.provider_oidc_gongchengwbs.domain.RPHolder;
import com.provider_oidc_gongchengwbs.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gongchengwbs/oidc-gongchengwbs-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gongchengwbs/oidc-gongchengwbs-rpholder.json";
