...
import com.provider_oidc_yangong.entity.AuthEntityRepository;
import com.provider_oidc_yangong.entity.OrgLogEntityRepository;
import com.provider_oidc_yangong.entity.PortalData;
import com.provider_oidc_yangong.entity.PostChangeLogEntityRepository;
 ...
 */
@RestController
@RequestMapping("/yangong")
public class DevYanGongController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12178/yangong/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12178/yangong/message");
