package com.provider_oidc_yangong.infrastructure;

import com.provider_oidc_yangong.domain.RPHolder;
import com.provider_oidc_yangong.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_yangong/oidc-yangong-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-yangong/oidc-yangong-rpholder.json";
