package com.provider_oidc_wuzi.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_wuzi.domain.DateUtils;
import com.provider_oidc_wuzi.domain.RPHolder;
import com.provider_oidc_wuzi.domain.shared.Application;
import com.provider_oidc_wuzi.entity.AuthEntityRepository;
import com.provider_oidc_wuzi.entity.OrgLogEntityRepository;
import com.provider_oidc_wuzi.entity.PortalData;
import com.provider_oidc_wuzi.entity.PostChangeLogEntityRepository;
import com.provider_oidc_wuzi.service.OIDCClientService;
import com.provider_oidc_wuzi.service.dto.UserInfoDto;
...
@RestController
@RequestMapping("/wuzi")
public class DevWuZiController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12195/wuzi/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12195/wuzi/message");
