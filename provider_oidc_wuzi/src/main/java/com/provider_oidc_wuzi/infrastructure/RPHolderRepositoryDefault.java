package com.provider_oidc_wuzi.infrastructure;

import com.provider_oidc_wuzi.domain.RPHolder;
import com.provider_oidc_wuzi.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_wuzi/oidc-wuzi-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-wuzi/oidc-wuzi-rpholder.json";
