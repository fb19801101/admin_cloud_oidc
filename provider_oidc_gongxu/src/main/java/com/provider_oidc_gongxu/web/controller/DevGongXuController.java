package com.provider_oidc_gongxu.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gongxu.domain.DateUtils;
import com.provider_oidc_gongxu.domain.RPHolder;
import com.provider_oidc_gongxu.domain.shared.Application;
import com.provider_oidc_gongxu.entity.AuthEntityRepository;
import com.provider_oidc_gongxu.entity.OrgLogEntityRepository;
import com.provider_oidc_gongxu.entity.PortalData;
import com.provider_oidc_gongxu.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongxu.service.OIDCClientService;
import com.provider_oidc_gongxu.service.dto.UserInfoDto;
...
public class DevGongXuController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12186/gongxu/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12186/gongxu/message");
