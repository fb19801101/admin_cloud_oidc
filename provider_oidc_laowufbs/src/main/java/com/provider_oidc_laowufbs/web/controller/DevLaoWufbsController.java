package com.provider_oidc_laowufbs.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_laowufbs.domain.DateUtils;
import com.provider_oidc_laowufbs.domain.RPHolder;
import com.provider_oidc_laowufbs.domain.shared.Application;
import com.provider_oidc_laowufbs.entity.AuthEntityRepository;
import com.provider_oidc_laowufbs.entity.OrgLogEntityRepository;
import com.provider_oidc_laowufbs.entity.PortalData;
import com.provider_oidc_laowufbs.entity.PostChangeLogEntityRepository;
import com.provider_oidc_laowufbs.service.OIDCClientService;
import com.provider_oidc_laowufbs.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/laowufbs")
public class DevLaoWufbsController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12172/laowufbs/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12172/laowufbs/message");
