package com.provider_oidc_laowufbs.infrastructure;

import com.provider_oidc_laowufbs.domain.RPHolder;
import com.provider_oidc_laowufbs.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_laowufbs/oidc-laowufbs-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-laowufbs/oidc-laowufbs-rpholder.json";
