package com.provider_oidc_gongcheng.infrastructure;

import com.provider_oidc_gongcheng.domain.RPHolder;
import com.provider_oidc_gongcheng.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gongcheng/oidc-gongcheng-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gongcheng/oidc-gongcheng-rpholder.json";
