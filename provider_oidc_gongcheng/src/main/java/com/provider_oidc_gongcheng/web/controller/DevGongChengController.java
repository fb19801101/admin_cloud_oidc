...
import com.provider_oidc_gongcheng.entity.AuthEntityRepository;
import com.provider_oidc_gongcheng.entity.OrgLogEntityRepository;
import com.provider_oidc_gongcheng.entity.PortalData;
import com.provider_oidc_gongcheng.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongcheng.service.OIDCClientService;
import com.provider_oidc_gongcheng.service.dto.AuthAccessTokenDto;
import com.provider_oidc_gongcheng.service.dto.UserInfoDto;
...
public class DevGongChengController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12198/gongcheng/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12198/gongcheng/message");
