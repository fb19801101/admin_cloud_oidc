package com.provider_oidc_gongchengbm.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_gongchengbm.domain.DateUtils;
import com.provider_oidc_gongchengbm.domain.RPHolder;
import com.provider_oidc_gongchengbm.domain.shared.Application;
import com.provider_oidc_gongchengbm.entity.AuthEntityRepository;
import com.provider_oidc_gongchengbm.entity.OrgLogEntityRepository;
import com.provider_oidc_gongchengbm.entity.PortalData;
import com.provider_oidc_gongchengbm.entity.PostChangeLogEntityRepository;
import com.provider_oidc_gongchengbm.service.OIDCClientService;
import com.provider_oidc_gongchengbm.service.dto.UserInfoDto;
 ...
 */
@RestController
@RequestMapping("/gongchengbm")
public class DevGongChengbmController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12197/gongchengbm/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12197/gongchengbm/message");
