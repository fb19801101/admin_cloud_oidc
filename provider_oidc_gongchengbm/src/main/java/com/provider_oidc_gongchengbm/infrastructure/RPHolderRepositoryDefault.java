package com.provider_oidc_gongchengbm.infrastructure;

import com.provider_oidc_gongchengbm.domain.RPHolder;
import com.provider_oidc_gongchengbm.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_gongchengbm/oidc-gongchengbm-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-gongchengbm/oidc-gongchengbm-rpholder.json";
