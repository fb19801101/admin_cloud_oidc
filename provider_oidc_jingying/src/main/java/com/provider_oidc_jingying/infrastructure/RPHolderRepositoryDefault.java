package com.provider_oidc_jingying.infrastructure;

import com.provider_oidc_jingying.domain.RPHolder;
import com.provider_oidc_jingying.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_jingying/oidc-jingying-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-jingying/oidc-jingying-rpholder.json";
