package com.provider_oidc_jingying.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_jingying.domain.DateUtils;
import com.provider_oidc_jingying.domain.RPHolder;
import com.provider_oidc_jingying.domain.shared.Application;
import com.provider_oidc_jingying.entity.AuthEntityRepository;
import com.provider_oidc_jingying.entity.OrgLogEntityRepository;
import com.provider_oidc_jingying.entity.PortalData;
import com.provider_oidc_jingying.entity.PostChangeLogEntityRepository;
import com.provider_oidc_jingying.service.OIDCClientService;
import com.provider_oidc_jingying.service.dto.UserInfoDto;
...
public class DevJingYingController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12176/jingying/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12176/jingying/message");
