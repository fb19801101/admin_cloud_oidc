package com.provider_oidc_shebei.infrastructure;

import com.provider_oidc_shebei.domain.RPHolder;
import com.provider_oidc_shebei.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_shebei/oidc-shebei-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-shebei/oidc-shebei-rpholder.json";
