...
import com.provider_oidc_shebei.entity.OrgLogEntityRepository;
import com.provider_oidc_shebei.entity.PortalData;
import com.provider_oidc_shebei.entity.PostChangeLogEntityRepository;
...
public class DevSheBeiController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12194/shebei/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12194/shebei/message");
