package com.provider_oidc_ldsc.service.impl;

import com.provider_oidc_ldsc.service.business.OIDCTokenVerifier;
import com.provider_oidc_ldsc.domain.RPHolder;
import com.provider_oidc_ldsc.domain.RPHolderRepository;
...
public class OIDCClientServiceImpl implements OIDCClientService {
    ...
    @Override
    public RPHolder loadApiRPHolder(String apiName) {
        return rpHolderRepository.findApiRPHolder(apiName);
    }

    @Override
    public List<RPHolder> loadApiRPHolders() {
        Map<String, RPHolder> apis = rpHolderRepository.findApiRPHolders();
    ...
    public boolean saveApiRPHolder(String apiName, RPHolder apiRpHolder) {
        boolean saveOK = rpHolderRepository.saveApiRPHolder(apiName, apiRpHolder);
        return saveOK && apiRpHolder.getDiscoveryEndpointInfo() != null;
    }
