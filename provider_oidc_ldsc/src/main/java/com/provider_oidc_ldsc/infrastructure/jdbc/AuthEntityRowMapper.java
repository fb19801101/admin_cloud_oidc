...
import com.provider_oidc_ldsc.entity.AuthEntity;
...
public class AuthEntityRowMapper implements RowMapper<AuthEntity> {
    ...
    public AuthEntity mapRow(ResultSet rs, int i) throws SQLException {
        ...
        authEntity.setOperatorId(rs.getInt("operator_id"));

        authEntity.setObjProvider(rs.getString("obj_provider"));
        authEntity.setObjId(rs.getInt("obj_id"));
        authEntity.setObjType(rs.getInt("obj_type"));
        authEntity.setObjNode(rs.getInt("obj_node"));
        authEntity.setObjName(rs.getString("obj_name"));
        authEntity.setObjPostId(rs.getInt("obj_post_id"));
        ...
        authEntity.setObjIndex(rs.getInt("obj_index"));

        authEntity.setNodeProvider(rs.getString("node_provider"));
        authEntity.setNodeId(rs.getInt("node_id"));
        authEntity.setNodeCode(rs.getString("node_code"));
        authEntity.setNodeType(rs.getInt("node_type"));
        authEntity.setNodePath(rs.getString("node_path"));
        authEntity.setNodeIndex(rs.getInt("node_index"));

        authEntity.setNodeParentProvider(rs.getString("node_parent_provider"));
        authEntity.setNodeParentId(rs.getInt("node_parent_id"));
        authEntity.setNodeParentCode(rs.getString("node_parent_code"));
        authEntity.setNodeParentType(rs.getInt("node_parent_type"));
        authEntity.setNodeParentPath(rs.getString("node_parent_path"));
        authEntity.setNodeParentIndex(rs.getInt("node_parent_index"));

        authEntity.setAuthRole(AuthRole.valueOf(rs.getString("auth_role")));
        authEntity.setAuthFlag(rs.getBoolean("auth_flag"));
        authEntity.setAuthOrg(rs.getInt("auth_org"));
        authEntity.setAuthOpAuth(rs.getInt("auth_op_auth"));
        authEntity.setAuthQueryAuth(rs.getInt("auth_query_auth"));
        authEntity.setAuthLog(rs.getInt("auth_log"));
        authEntity.setAuthPostChange(rs.getInt("auth_post_change"));
        authEntity.setAuthPostDelete(rs.getInt("auth_post_delete"));
