package com.provider_oidc_ldsc.infrastructure;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_ldsc/oidc-ldsc-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-ldsc/oidc-ldsc-rpholder.json";
