...
public class AuthEntity implements Serializable {
	...
	public AuthEntity(Integer id, String providerId, Integer operatorId, String objProvider, Integer objId, Integer objType, Integer objNode, String objName, Integer objPostId, String objPostName, String objPostCode, String objPath, Integer objIndex, String nodeProvider, Integer nodeId, String nodeCode, Integer nodeType, String nodePath, Integer nodeIndex, String nodeParentProvider, Integer nodeParentId, String nodeParentCode, Integer nodeParentType, String nodeParentPath, Integer nodeParentIndex, Integer authOrg, Integer authOpAuth, Integer authQueryAuth, Integer authLog, Integer authPostChange, Integer authPostDelete) {
		...
		this.authOpAuth = authOpAuth;
		this.authQueryAuth = authQueryAuth;
		this.authLog = authLog;
		this.authPostChange = authPostChange;
		this.authPostDelete = authPostDelete;
