package com.provider_oidc_jiliang.infrastructure;

import com.provider_oidc_jiliang.domain.RPHolder;
import com.provider_oidc_jiliang.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_jiliang/oidc-jiliang-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-jiliang/oidc-jiliang-rpholder.json";
