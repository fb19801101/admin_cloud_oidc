package com.provider_oidc_jiliang.web.controller;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.provider_oidc_jiliang.domain.DateUtils;
import com.provider_oidc_jiliang.domain.RPHolder;
import com.provider_oidc_jiliang.domain.shared.Application;
import com.provider_oidc_jiliang.entity.AuthEntityRepository;
import com.provider_oidc_jiliang.entity.OrgLogEntityRepository;
import com.provider_oidc_jiliang.entity.PortalData;
import com.provider_oidc_jiliang.entity.PostChangeLogEntityRepository;
import com.provider_oidc_jiliang.service.OIDCClientService;
import com.provider_oidc_jiliang.service.dto.UserInfoDto;
...
public class DevJiLiangController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12181/jiliang/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12181/jiliang/message");
