package com.provider_oidc_shebeigys.infrastructure;

import com.provider_oidc_shebeigys.domain.RPHolder;
import com.provider_oidc_shebeigys.domain.RPHolderRepository;
...
public class RPHolderRepositoryDefault implements RPHolderRepository {
    ...
    //文件名
    private static final String FILE_LOCAL = "provider_oidc_shebeigys/oidc-shebeigys-rpholder.json";
    private static final String FILE_SERVE = "/opt/oidc-project/config/oidc-shebeigys/oidc-shebeigys-rpholder.json";
