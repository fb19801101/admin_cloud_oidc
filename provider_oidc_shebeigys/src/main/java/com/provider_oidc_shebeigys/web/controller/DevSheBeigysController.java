...
import com.provider_oidc_shebeigys.entity.AuthEntityRepository;
import com.provider_oidc_shebeigys.entity.OrgLogEntityRepository;
import com.provider_oidc_shebeigys.entity.PortalData;
 ...
 */
@RestController
@RequestMapping("/shebeigys")
public class DevSheBeigysController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12192/shebeigys/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12192/shebeigys/message");
