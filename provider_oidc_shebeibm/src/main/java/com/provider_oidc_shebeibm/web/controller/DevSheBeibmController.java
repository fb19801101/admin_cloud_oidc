...
import com.provider_oidc_shebeibm.entity.PortalData;
 ...
 */
@RestController
@RequestMapping("/shebeibm")
public class DevSheBeibmController {
    @Autowired
    ...
    public @ResponseBody PortalData todoList(String sub, int cat) {
        ...
        JSONObject json = new JSONObject();
        json.put("url", "http://ldsc.cr121.com:12174/shebeibm/todoList");
    ...
    public @ResponseBody PortalData presses(String kwds, int type) {
        ...
        json.put("more", "http://ldsc.cr121.com:12174/shebeibm/message");
